...
class Program {
    ...
    public enum RecStatus {
        FAILED      (-9,    "Failed"),
        TUNERBUSY   (-8,    "The tuner is busy"),
        LOWSPACE    (-7,    "Disk space too low"),  
        CANCELLED   (-6,    "Cancelled"),
        MISSED      (-5,    "Missed"),
        ABORTED     (-4,    "Aborted"),
        RECORDED    (-3,    "Recorded"),           
        RECORDING   (-2,    "Recording"),       
        WILLRECORD  (-1,    "Will record"),        
        UNKNOWN     (0,     "Unknown"),
        DONTRECORD  (1,     "Don't record"),  
        PREVIOUS    (2,     "Previous recording"),
        CURRENT     (3,     "Current recording"),  
        EARLIER     (4,     "Earlier showing"),
        TOOMANY     (5,     "Too many recordings"), 
        NOTLISTED   (6,     "Not listed"), 
        CONFLICT    (7,     "Conflict"),
        LATER       (8,     "Later showing"), 
        REPEAT      (9,     "Repeat"),
        INACTIVE    (10,    "Inactive"), 
        NEVERRECORD (11,    "Never record"),
        OFFLINE     (12,    "Offline"), 
        OTHER       (13,    "Other showing");
